...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: 'ul', items: ['Lepterija i uspon do Sokograda', 'Vodopad Ripaljka', 'Župan plaža i Park Banjica', 'Tursko kupatilo Amam', 'Bovansko jezero', 'Sesalačka pećina', 'Očno i Kalinovica', 'Čuka 2 park', 'Selo Vrmdža', 'Planina Rtanj'] },
      ...
      { type: 'p', text: 'Golden View je novosagrađeni kompleks modernih apartmana sa restoranom i bazenom na svega 300 metara od akva parka i 10 minuta hoda od centra grada.' },
      { type: 'p', text: 'Naši apartmani su idealni za porodice i parove — novi i veoma komforni, sa pogledom na Rtanj, a ponuda našeg restorana je krojena za prave hedoniste: specijaliteti sa roštilja od junećeg mesa, kremaste paste i deserti koji se pamte. Room service je takođe dostupan, kao i parking i brz besplatan Wi-Fi za sve goste kompleksa.' },
  ...
  },
  {
    ...
    readingMinutes: 6,
    body: [
      { type: 'p', text: 'Akva park „Podina” jedno je od najposećenijih mesta u Sokobanji tokom leta. Smešten u okviru sportskog kompleksa Podina, na oko 1.500 m od centra grada, park pruža kombinaciju zabave i relaksacije za sve generacije.' },
      ...
      { type: 'p', text: 'Ako tražite smeštaj u blizini Akva Parka, možete odsedati u Golden View Sokobanja — modernom apartmanskom kompleksu koji kombinuje komfor, mir i odličnu lokaciju. Uz to, Golden View apartmani vam nude i bazen, ukoliko vas umori gužva u akva parku.' },
      ...
      { type: 'p', text: 'U neposrednoj blizini apartmana nalazi se Restoran Golden View, jedno od najlepših mesta za ručak ili večeru u Sokobanji. Restoran kombinuje tradicionalnu kuhinju sa modernim ambijentom, a na meniju se nalaze jela domaće kuhinje i roštilj, sveže salate i lokalni specijaliteti, kao i kolači i poslastice uz kafu ili vino.' },
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Kafana Zelengora je simbol Sokobanje i jedno od onih mesta koje svi preporučuju. Ovde se oseća duh starog juga, onaj topli, neposredni pristup koji podseća na neka starija vremena. Unutrašnji prostor odiše tradicijom, a u večernjim satima kafana oživi uz muziku, smeh i druženje.' },
      { type: 'h2', text: '2. Župan Restoran' },
      { type: 'p', text: 'Restoran Župan nalazi se nadomak reke Moravice u naselju Jabukar i predstavlja elegantan spoj udobnosti i tradicije. Ambijent je klasičan, uređen sa pažnjom i stilom, a atmosfera mirna i prijatna — popularan među poslovnim gostima i porodicama.' },
      { type: 'h2', text: '3. Restoran Golden View' },
      { type: 'p', text: 'Restoran Golden View je mesto koje osvaja već na prvi pogled. Nalazi se u naselju Palilula i pruža posetiocima predivan ambijent. Enterijer je moderan ali prijatan, a atmosfera smirena i elegantna — spoj autentičnih ukusa juga Srbije i udobnosti.' },
      ...
      { type: 'p', text: 'Zaplet unosi dašak modernog duha u Sokobanju. Enterijer je savremen, bašta prostrana i osvetljena, a pogled na centar Sokobanje i zavičajni muzej posebno lep u večernjim satima. Mesto koje privlači mlađe goste, parove i grupe prijatelja.' },
